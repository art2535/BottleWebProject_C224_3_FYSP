                ...
                <div class="matrix-card">
                    ...
                    <div class="input-group">
                        <div class="input-item">
                            ...
                            <input type="number" name="n" id="n-vertices" class="input-field" min="3" max="7" required value="{{ form_data.get('n', '3') }}">
                        </div>
                    </div>
                    <div class="adjacency-matrix">
                        <h3>Adjacency Matrix</h3>
                        <table class="compact-matrix" id="adjacency-table"></table>
                    </div>
                    <div class="adjacency-matrix">
                        <h3>Weight Matrix</h3>
                        <table class="compact-matrix" id="weights-table"></table>
                    </div>
                </div>
                <!-- Graph and result -->
